...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    cd ~
    git clone https://github.com/momopay/momo-pool.git
...
output ""
output "If you found this script helpful please consider donating some BTC Donation: 1ESWawzFjKEBqcbj79Z2M42u2HxmejWbYG "
